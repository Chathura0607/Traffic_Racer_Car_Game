$(document).ready(function () {
  const gameArea = $("#race_track");
  const playerCar = $("#player_car");
  let score = 0;
  let speed = 5;
  let gameInterval;
  ...
  function startGame() {
    ...
    $("#menu").addClass("hidden"); // Hide menu
  ...
  function endGame() {
    ...
    $("#start_game").text("Try Again"); // Show Try Again button
    $("#menu").removeClass("hidden"); // Show menu
  }
